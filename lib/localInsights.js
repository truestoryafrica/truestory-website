...
export async function addLocalInsight(input) {
  ...
  await sql`
    insert into insights (id, title, slug, category, excerpt, body_html, author, reading_time, tags, status, image, alt, date, updated_at, seo_title, seo_description)
    values (${insight.id}, ${insight.title}, ${insight.slug}, ${insight.category}, ${insight.excerpt}, ${insight.bodyHtml}, ${insight.author}, ${insight.readingTime}, ${insight.tags}, ${insight.status}, ${insight.image}, ${insight.alt}, ${insight.date}, ${insight.updatedAt}, ${insight.seoTitle}, ${insight.seoDescription})
